...
Create a 1200x630 hero image for an InfoWeb blog post titled "Como Conseguir Mais Avaliações Google para o Seu Negócio".
...
Scene: cartões de cinco estrelas e telemóvel com ecrã de pedido de avaliação. Use Portuguese/local business context where relevant.
