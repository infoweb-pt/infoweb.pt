...
Create a 1200x630 hero image for an InfoWeb blog post titled "Quando Redesenhar o Website do Seu Pequeno Negócio".
...
Scene: janelas de browser antes/depois com refresh moderno de website. Use Portuguese/local business context where relevant.
