...
Create a 1200x630 hero image for an InfoWeb blog post titled "Preços de Ementa: Custo Alimentar, Margens e Gorjetas".
...
Scene: ementa, calculadora e gráfico de custo alimentar. Use Portuguese/local business context where relevant.
