...
Create a 1200x630 hero image for an InfoWeb blog post titled "Valor de Vida do Cliente (LTV) para Pequenos Negócios".
...
Scene: setas de cliente repetido e badge LTV em euros. Use Portuguese/local business context where relevant.
