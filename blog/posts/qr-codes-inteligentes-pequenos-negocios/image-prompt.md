...
Create a 1200x630 hero image for an InfoWeb blog post titled "QR Codes Inteligentes para Marketing de PME".
...
Scene: vários QR com ondas de analytics e logótipo ao centro. Use Portuguese/local business context where relevant.
