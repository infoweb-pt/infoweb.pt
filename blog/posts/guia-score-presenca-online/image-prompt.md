...
Create a 1200x630 hero image for an InfoWeb blog post titled "Como Avaliar o Score de Presença Online do Seu Negócio".
...
Scene: medidor circular de score e ícones de mapa em dashboard navy. Use Portuguese/local business context where relevant.
