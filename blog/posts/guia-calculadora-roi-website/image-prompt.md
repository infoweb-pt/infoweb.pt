...
Create a 1200x630 hero image for an InfoWeb blog post titled "Como Calcular o ROI de um Website para PME".
...
Scene: curva de receita e ícones de calculadora em infográfico navy dourado. Use Portuguese/local business context where relevant.
