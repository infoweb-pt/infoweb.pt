...
Create a 1200x630 hero image for an InfoWeb blog post titled "Parâmetros UTM: Rastrear Campanhas que Convertem".
...
Scene: barra de URL com parâmetros UTM destacados a dourado. Use Portuguese/local business context where relevant.
