...
Create a 1200x630 hero image for an InfoWeb blog post titled "UTM Parameters: Track Marketing Campaigns That Actually Convert".
...
Scene: browser address bar with utm parameters highlighted in gold. Use international small-business context.
