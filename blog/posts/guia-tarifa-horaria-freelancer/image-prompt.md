...
Create a 1200x630 hero image for an InfoWeb blog post titled "Como Definir a Sua Tarifa Horária de Freelancer (Sem Se Vender Barato)".
...
Scene: relógio, euro e pilha de faturas em ilustração navy dourado. Use Portuguese/local business context where relevant.
