...
Create a 1200x630 hero image for an InfoWeb blog post titled "Customer Lifetime Value (LTV) for Small Businesses".
...
Scene: repeat customer loop arrows and euro LTV badge on dark dashboard. Use international small-business context.
