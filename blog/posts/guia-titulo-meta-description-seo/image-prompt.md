...
Create a 1200x630 hero image for an InfoWeb blog post titled "Guia de Título SEO e Meta Description para Websites de PME".
...
Scene: snippet de resultado Google com título e descrição destacados a dourado em fundo navy. Use Portuguese/local business context where relevant.
