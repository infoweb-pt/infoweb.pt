...
- [Menu QR generator](https://infoweb.sousadev.com/free-tools/menu-qr-generator/) — upload PDF, brand colours, scan stats
- [WhatsApp QR generator](https://infoweb.sousadev.com/free-tools/whatsapp-qr-generator/) — pre-filled chat for orders

See our [restaurant menu QR guide](/blog/posts/restaurant-menu-qr-code-guide/) for placement tips.

## Wi-Fi and business cards

- **Guest Wi-Fi:** [Wi-Fi QR generator](https://infoweb.sousadev.com/free-tools/wifi-qr-generator/) encodes join credentials (no typing passwords).
- **Networking:** [Digital business card QR](https://infoweb.sousadev.com/free-tools/business-card-qr/) saves your vCard in one scan.
