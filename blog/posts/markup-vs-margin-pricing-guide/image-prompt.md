...
Create a 1200x630 hero image for an InfoWeb blog post titled "Markup vs Margin: Price Products Without Guessing".
...
Scene: two bar charts labeled markup and margin with percent badges. Use international small-business context.
