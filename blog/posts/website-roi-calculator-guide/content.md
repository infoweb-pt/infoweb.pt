...
The [website ROI calculator](https://infoweb.sousadev.com/free-tools/website-roi-calculator/) models monthly and annual revenue from visitors × conversion × order value, then compares against cost.
...
One-off jobs understate ROI for repeat businesses (salons, clinics, B2B services). Use the [customer LTV calculator](https://infoweb.sousadev.com/free-tools/customer-ltv-calculator/) to see what a loyal customer is worth over a year.
