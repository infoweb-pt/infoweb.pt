...
The [break-even calculator](https://infoweb.sousadev.com/free-tools/break-even-calculator/) does the division and shows how many sales you need per month and per week.

Example: €4,000 fixed costs, €120 price, €45 variable cost → €75 contribution → ~54 sales/month to break even.

## Connect to pricing

If break-even units feel unrealistic, your margin is too thin. Use the [markup vs margin calculator](https://infoweb.sousadev.com/free-tools/markup-margin-calculator/) to reset prices before cutting costs blindly.
