...
Create a 1200x630 hero image for an InfoWeb blog post titled "Markup vs Margem: Defina Preços Sem Adivinhar".
...
Scene: dois gráficos de barras markup e margem com percentagens. Use Portuguese/local business context where relevant.
