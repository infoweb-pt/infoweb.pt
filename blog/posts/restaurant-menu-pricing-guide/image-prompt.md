...
Create a 1200x630 hero image for an InfoWeb blog post titled "Restaurant Menu Pricing: Food Cost, Margins, and Tips".
...
Scene: menu clipboard, calculator, and plate cost percentage chart. Use international small-business context.
