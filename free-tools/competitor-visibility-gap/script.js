...
// Local dev: http://localhost:8001/leads/competitor-visibility-gap/ (run `python manage.py runserver 8001` in api/).
// Expected POST body: { email, score, answers }
const API_ENDPOINT = 'https://infoweb.api.sousadev.com/leads/competitor-visibility-gap/';
...
const MAX_RAW_SCORE = QUESTIONS.reduce((sum, q) => sum + q.points, 0); // 84
